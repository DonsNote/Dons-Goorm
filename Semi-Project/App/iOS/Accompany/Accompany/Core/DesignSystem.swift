...
extension Color {
    enum App {
        ...
        /// 라이트 크림 배경 #F5F0E8 / 다크 #1B2B24
        static let lightBg       = Color(UIColor { t in
            t.userInterfaceStyle == .dark
                ? UIColor(red: 0.106, green: 0.169, blue: 0.141, alpha: 1)
                : UIColor(red: 0.96,  green: 0.94,  blue: 0.91,  alpha: 1)
        })
        /// 카드 배경 / 다크 #263C32
        static let cardBg        = Color(UIColor { t in
            t.userInterfaceStyle == .dark
                ? UIColor(red: 0.149, green: 0.231, blue: 0.196, alpha: 0.9)
        ...
        /// 틸 배경 서브 #D9EBDF / 다크 #1A3329
        static let accentSubtle  = Color(UIColor { t in
            t.userInterfaceStyle == .dark
                ? UIColor(red: 0.102, green: 0.200, blue: 0.161, alpha: 1)
                : UIColor(red: 0.85,  green: 0.92,  blue: 0.88,  alpha: 1)
        })
        /// 짙은 그린 (진행 바) #2E4738
        ...
        /// 경고 빨강 배경 / 다크 #3D1C1C
        static let warningBg     = Color(UIColor { t in
            t.userInterfaceStyle == .dark
                ? UIColor(red: 0.239, green: 0.110, blue: 0.110, alpha: 1)
                : UIColor(red: 1.00,  green: 0.88,  blue: 0.88,  alpha: 1)
        })
